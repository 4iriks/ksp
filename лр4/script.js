...
const renderCart = () => {
    ...
    if (!cartList || !cartTotal) return; // Защита от ошибок, если элементы не найдены
    ...
    cart.forEach((item, index) => {
        const div = document.createElement("div"); // Создание контейнера для товара
        div.className = "cart-item"; // Добавление класса для стилизации
        ...
        div.appendChild(span); //дочерний внутрь родительского
        div.appendChild(btn);
